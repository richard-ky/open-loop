%function[time,v_Ems,v_Ims,S_EIms,S_IEms,S_EEms,S_IIms,X_EIms,X_IEms,X_EEms,X_IIms,Apostms,Aprems,W_IEms,Weight_0,W_IE,spt_Ems,leftover_S_EI0,leftover_S_IE0,leftover_S_II0,leftover_S_EE0,spike_time_E,W_IEfs,RE,Ue,Ui,spike_E,spike_I] = neuron_network(vE0,vI0,S_EI0,S_IE0,S_EE0,S_II0,X_EI0,X_IE0,X_EE0,X_II0,Apost0,Apre0,W_IE0,W_EI0,W_EE0,W_II0,leftover_S_EI,leftover_S_IE,leftover_S_EE,leftover_S_II,spt_E0,duration,S_key_EI,S_key_IE,S_key_EE,S_key_II,N_E,N_I,J_IE,J_EI,J_EE,J_II,plast_on,stim_on,dxlE,dxlI,VstimE,VstimI,Stimoffduration,step)
function[time,W_IE,RE,v_Ems,v_Ims,S_EIms,S_IEms,S_EEms,S_IIms,X_EIms,X_IEms,X_EEms,X_IIms,Apostms,Aprems,W_IEms,spt_Ems,leftover_S_EI0,leftover_S_IE0,leftover_S_II0,leftover_S_EE0] = neuron_network(duration,Stimoffduration,step,N_E,N_I,stim_on,plast_on,T_stim,x_neutral,VstimE,VstimI,dxlE,dxlI,vE0,vI0,S_EI0,S_IE0,S_II0,S_EE0,X_EI0,X_IE0,X_EE0,X_II0,Apost0,Apre0,W_IE0,W_EI0,W_II0,W_EE0,J_EI,J_EE,J_IE,J_II,S_key_EI,S_key_IE,S_key_EE,S_key_II,leftover_S_EI,leftover_S_IE,leftover_S_EE,leftover_S_II,spt_E0)  
...
%clear -vars
    ...
    W_IE = zeros(duration_step,1); % E-to-I synaptic weights Storage
    ...
    sample_duration = 144;%duration; %Duration for each short simulation
    Synchrony = zeros(duration/sample_duration,1);
    time_syn = zeros(duration/sample_duration,1);
    
    % Generate General Stimulation Patter
    V_stimE0 = 1; %E stim amplitude
    V_stimI0 = 1; %I stim amplitude
    multiple = 1;
    
    
    [Ue,Ui] = pulsatile_input(multiple,V_stimE0,V_stimI0,T_stim,x_neutral,duration,step,Stimoffduration);
    ...
    for ii = 1:duration/sample_duration
        ...
        ON = stim_on;% turn on control input stim_on = 0 - OFF, stim_on = 1 - ON
        ...
        %Multiply the generic stim pattern with desired amplitude
        ue = VstimE*Ue(:,a:b);
        ui = VstimI*Ui(:,a:b);
       ...
       [timem, v_Em, v_Im, S_EIm, S_IEm, S_EEm, S_IIm, X_EIm, X_IEm, X_EEm, X_IIm, Apostm, Aprem, W_IEm, spike_Em, spike_Im, ref_Em, ref_Im, synchronym, spt_Em] = ode_neuron_model(plast_on,ON,vE0,vI0,S_EI0,S_IE0,S_II0,S_EE0,X_EI0,X_IE0,X_EE0,X_II0,Apost0,Apre0,W_IE0,W_EI0,W_II0,W_EE0,mew_e,sigma_e,ue,ui,mew_i,sigma_i,J_EI,J_EE,J_IE,J_II,C_EI,C_IE,C_EE,C_II,tau_LTP,tau_LTD,step,sample_duration,N_E,N_I,S_key_EI,S_key_IE,S_key_EE,S_key_II,leftover_S_EI,leftover_S_IE,leftover_S_EE,leftover_S_II,ref_E,ref_I,tau_E_m,tau_I_m,comp_time,spt_E0,dxlE,dxlI);
        
       % recorded variables
       %time stamps of simulation
        time(a:b,:) = timem(1:sample_duration/step,:) + (ii-1)*sample_duration;
