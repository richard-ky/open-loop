...
%Simulations
    ...
    folderName = strcat('E',num2str(E),'I',num2str(I),'PW',num2str(T))
    mkdir(folderName)
    save([folderName,'/Stim_data_analysis_',' JIE ',num2str(J_IE),'AmpE',num2str(VstimE),'AmpI',num2str(VstimI),'PW',num2str(T_stim), '.mat'],'REf','timef','W_IEA','-v7.3')
end